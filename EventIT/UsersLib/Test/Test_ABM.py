...
class test_dar_baja_o_alta(unittest.TestCase):
    ...
    def test_dar_alta(self):
        ...
        ABM.dar_alta("user", "Roberto", 1, 1234, self.reg_de_usuarios)

        self.assertEqual(len(self.reg_de_usuarios.Get_Ciudadanos()), 1)

        ABM.dar_alta("user", "Roberto", 1, 1234, self.reg_de_usuarios)
        ABM.dar_alta("user", "Bruno", 2, 4321, self.reg_de_usuarios)
        ABM.dar_alta("user", "Pablo", 3, 3214, self.reg_de_usuarios)
