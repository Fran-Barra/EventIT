...
class TestPrueba(unittest.TestCase):
    def setUp(self):
        ...
        self.evento1 = Evento('Fiesta', self.Mapa.search_ubicacion(1,1), 'Evento1')
        self.evento2 = Evento('Sanitario', self.Mapa.search_ubicacion(2,2), 'Evento2')
        self.evento3 = Evento('Social', self.Mapa.search_ubicacion(1,3), 'Evento3')
        self.evento4 = Evento('Privado', self.Mapa.search_ubicacion(6,4), 'Evento4')
