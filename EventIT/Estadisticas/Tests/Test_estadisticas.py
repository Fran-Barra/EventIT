...
class TestPrueba(unittest.TestCase):
    def setUp(self):
        ...
        self.evento1 = Evento('Fiesta', self.Mapa.search_ubicacion(0,0), 'Evento1')
        self.evento2 = Evento('Sanitario', self.Mapa.search_ubicacion(0,0), 'Evento2')
        self.evento3 = Evento('Social', self.Mapa.search_ubicacion(0,0), 'Evento3')
        self.evento4 = Evento('Privado', self.Mapa.search_ubicacion(0,0), 'Evento4')
